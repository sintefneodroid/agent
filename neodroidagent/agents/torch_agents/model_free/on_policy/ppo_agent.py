...
from warg import GDKC, drop_unused_kws, is_none_or_zero_or_negative_or_mod_zero, super_init_pass_on_kws
...
"""
  ...
  def inner_update(self, *transitions, metric_writer: Writer = None) -> Tuple:
    ...
    for (
      ...
      if metric_writer:
        metric_writer.scalar("policy_stddev", to_scalar(new_distribution.stddev))
