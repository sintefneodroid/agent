...
def parse_arguments(agent_description, default_config: NOD) -> NOD:
    ...
    add_bool_arg(
        ...
        "run_training",
        dest="RUN_TRAINING",
        converse="run_inference",
        default=default_config.RUN_TRAINING,
        help="train",
    )
    add_bool_arg(
        parser,
    ...
    add_bool_arg(
        ...
        dest="CONTINUE",
        converse="restart",
        default=default_config.CONTINUE,
    ...
    add_bool_arg(
        ...
        converse="wait_for_config_confirmation",
        default=True,
    ...
    parser.add_argument(
        ...
        metavar="ITERATIONS",
        help="Number of iterations (rollouts)",
    )
    parser.add_argument(
        "--CONFIG",
        "-config",
