...
def display_actor_configuration(
    env, candidate, frontier_displayer_name="FrontierPlotDisplayer"
):
    ...
    frontier_displayable = [
        Displayable(frontier_displayer_name, (success_estimates, actor_configurations))
    ]
